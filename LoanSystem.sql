...
insert into Student values
	-- StudentID char 8, FirstName char 35, LastName char 35, class char 5, StudentPassword char 30, StudentEmail char 30
    ('fraabd01', 'Franol', 'Abdulahi', 'im1a', 'Test', 'fraabd01@vgs.nfk.no'),
    ('meqabd17', 'Meqdam', 'Abdullah', 'im1a', 'Test', 'meqabd17@vgs.nfk.no'),
    ('odiand22', 'Odin', 'Kleveland', 'im1a', 'Test', 'odiand22@vgs.nfk.no'),
    ('geigje', 'Geir', 'Gjerde', 'TEAC', 'Test', 'geigje@vgs.nfk.no'),
    ('jelhla26', 'Jely', 'Hlawnceu', 'im1a', 'Test', 'jelhla26@vgs.nfk.no'),
    ('benive', 'Bente', 'Iversen', 'TEAC', 'Test', 'benive@vgs.nfk.no'),
    ('alvjac28', 'Alva', 'Jacobsen', 'im1a', 'Test', 'alvjac28@vgs.nfk.no'),
    ('wiljoh22', 'William', 'Johnsen', 'im1a', 'Test', 'wiljoh22@vgs.nfk.no'),
    ('elikje05', 'Elise', 'Kjervik', 'im1a', 'Test', 'elikje05@vgs.nfk.no'),
    ('isekol01', 'Iselin', 'Kolstad', 'im1a', 'Test', 'isekol01@vgs.nfk.no'),
    ('kollar', 'Kolbjoorn', 'Larsen', 'TEAC', 'Test', 'kollar@vgs.nfk.no'),
    ('sealon08', 'Sean', 'Long', 'im1a', 'Test', 'sealon08@vgs.nfk.no'),
    ('ismpre05', 'Ismael', 'Prescher', 'im1a', 'Test', 'ismpre05@vgs.nfk.no'),
    ('ingram09', 'Ingelinn', 'Ramberg', 'im1a', 'Test', 'ingram09@vgs.nfk.no'),
    ('vegrod15', 'Vegard', 'Roodsand', 'im1a', 'Test', 'vegrod15@vgs.nfk.no'),
    ('isastra11', 'Isak', 'Strand', 'im1a', 'Test', 'isastra11@vgs.nfk.no'),
    ('oveaal', 'Ove', 'Aalo', 'TEAC', 'Test', 'oveaal@vgs.nfk.no');
